...
plot(x, SubMatrixHMD1[,1],log="y", xlab ="trajectory length 100(red); 170(green); 200(blue)", ylab="variance of mean estimate", col="red",pch=16)
points(x,SubMatrixHMD2[,1], log="y", col="green", pch=16)
points(x,SubMatrixHMD3[,1], log="y", col="blue", pch=16)

## variance of variance estimate (NUTS & Independent)
plot(x, SubMatrixHMD1[,2],log="y", xlab ="trajectory length 100(red); 170(green); 200(blue)", ylab="variance of mean estimate", col="red",pch=16)
points(x,SubMatrixHMD2[,2], log="y", col="green", pch=16)
points(x,SubMatrixHMD3[,2], log="y", col="blue", pch=16)

########### HMC Dual with random trajectory (trajectory = 100, 170, 200)
## variance of mean estimate ()
plot(x, SubMatrixHMD1mod[,1],log="y", xlab ="trajectory length 100(red); 170(green); 200(blue)", ylab="variance of mean estimate", col="red",pch=16)
points(x,SubMatrixHMD2mod[,1], log="y", col="green", pch=16)
points(x,SubMatrixHMD3mod[,1], log="y", col="blue", pch=16)

## variance of variance estimate (NUTS & Independent)
plot(x, SubMatrixHMD1mod[,2],log="y", xlab ="trajectory length 100(red); 170(green); 200(blue)", ylab="variance of mean estimate", col="red",pch=16)
points(x,SubMatrixHMD2mod[,2], log="y", col="green", pch=16)
points(x,SubMatrixHMD3mod[,2], log="y", col="blue", pch=16)

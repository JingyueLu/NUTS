...
\begin{figure}[hbtp]
\center
\includegraphics{/homes/palma/Documents/NUTS/histsamples_doubexp.png}
...
\begin{figure}[hbtp]
\center
\includegraphics{/homes/palma/Documents/NUTS/PLOT2.png}
...
\begin{figure}[hbtp]
\center
\includegraphics{/homes/palma/Documents/NUTS/PLOT3.png}
...
\begin{figure}[hbtp]
\center
\includegraphics{/homes/palma/Documents/NUTS/DualAvPerf_30DimNormal.png}
\caption{Evaluation of Dual Averaging performances for the normal case}
\label{fig:dualavnorm}
\end{figure}
\begin{figure}[hbtp]
\center
\includegraphics{/homes/palma/Documents/NUTS/DualAv_doubexp.png}
...
\begin{figure}[hbtp]
\center
\includegraphics{/homes/palma/Documents/NUTS/ESSPerf_30DimNormal.png}
\caption{Evaluation of ESS performances for the normal case}
\label{fig:essnorm}
\end{figure}
\begin{figure}[hbtp]
\center
\includegraphics{/homes/palma/Documents/NUTS/ESS_doubleexp.png}
...
\begin{figure}[hbtp]
\center
\includegraphics{/homes/palma/Documents/NUTS/PLOT4.png}
